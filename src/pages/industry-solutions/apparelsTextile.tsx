...
export default function ApparelsTextilePage() {
  ...
  const keyAdvantages = [
    {
      ...
      description:
        "Expert order management and multi-channel fulfilment for seamless retail logistics.",
    },
    {
      icon: <FaShippingFast className="w-6 h-6 text-blue-600" />,
      title: "White Glove Delivery",
      description:
        "Premium delivery services ensuring timely and careful handling of fashion garments.",
    },
    {
      icon: <Factory className="w-6 h-6 text-blue-600" />,
      title: "Strategic Mumbai Hubs",
      description:
        "Strong presence across Mumbai, Nhava Sheva, and Bhiwandi — key gateways for trade, warehousing, and freight movement.",
    },
    {
      icon: <Globe className="w-6 h-6 text-blue-600" />,
      title: "Reverse Logistics",
      description:
        "Efficient reverse logistics solutions to manage returns and enhance customer satisfaction.",
    },
  ];

  const faqData = [
    {
      question: "What services do you offer for the apparels and textile industry?",
      answer:
        "We provide custom logistics solutions, including expert order management, multi-channel fulfilment, white glove delivery, reverse logistics, and tech-driven supply chain management for apparels and textiles.",
    },
    {
      question: "How do you ensure efficient retail logistics?",
      answer:
        "Our integrated system combines advanced technology, a specialized team, and a turn-key framework to ensure seamless order management, fulfilment, and delivery for the retail industry.",
    },
    {
      question: "Which areas in India do you serve for apparels and textile logistics?",
      answer:
        "We have a strong presence in Mumbai, Nhava Sheva, and Bhiwandi, key hubs for fashion garments, providing seamless logistics services across India.",
    },
    {
      question: "Do you support global apparels and textile logistics?",
      answer:
        "Yes, we support a global network, providing comprehensive logistics solutions for the apparels and textile industry worldwide.",
    },
    {
      question: "What technology do you use for apparels and textile logistics?",
      answer:
        "We employ advanced tracking, real-time updates, automation, and data analytics to ensure precision and efficiency in apparels and textile supply chains.",
    },
  ];
  ...
  const breadcrumbTrail = [
    ...
    { label: "Apparels & Textile", icon: <GiClothes /> },
  ];
            ...
            <div className="text-white">
              <div className="mb-6">
                <Chip className="mb-4" color="primary" variant="shadow">
                  Apparels & Textile Logistics
                </Chip>
                <h1 className="text-4xl md:text-5xl font-bold mb-4">
                  Apparels & Textile Solutions
                </h1>
                <h2 className="text-2xl md:text-3xl font-semibold mb-4 text-blue-200">
                  Seamless Logistics for Fashion Retail
                </h2>
                <p className="text-lg text-blue-100 mb-6">
                  Mansi Shipping Agency delivers tailored solutions for apparels and
                  textiles, ensuring flexibility and efficiency across global
                  supply chains.
                </p>
              </div>
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  <span className="text-blue-100">
                    Global Network for Retail Logistics
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Apparels & Textile – Flexibility, Efficiency, Global
            </h2>
            <div>
                    ...
                    <div className="flex-1">
                      <p className="text-xl text-gray-700 leading-relaxed">
                        ...
                        <span className="font-bold text-transparent bg-gradient-to-r from-blue-600 to-sky-400 bg-clip-text">
                          apparels and textile logistics
                        </span>
                        , serving fashion garments and retail industries with tailored solutions.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <p className="text-xl text-gray-700 leading-relaxed">
                        ...
                        <span className="font-bold text-blue-600">
                          presence in Mumbai, Nhava Sheva, and Bhiwandi
                        </span>{" "}
                        ensures seamless connectivity for fashion and retail logistics.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Tailored Logistics for Apparels & Textile
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our specialized services ensure flexibility, efficiency, and
              reliability for apparels and textile supply chains.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Precision Logistics for Apparels & Textile
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Know More About Apparels & Textile Logistics
            </h2>
            <p className="text-lg text-gray-600">
              Get answers to common questions about our logistics solutions for
              the apparels and textile industry.
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-800 rounded-[10px]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Need Flexible Apparels & Textile Logistics?
          </h2>
          <p className="text-xl text-blue-100 mb-8">
            Let Mansi Shipping Agency manage your apparels and textile supply chain
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-blue-100 text-sm">Multi-Channel Fulfilment</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-blue-100 text-sm">White Glove Services</p>
            </div>
          </div>
        </div>
      </section>
