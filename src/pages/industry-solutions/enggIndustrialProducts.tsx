...
import { FaUserGear, FaGears } from "react-icons/fa6";
import { TiHome } from "react-icons/ti";

import DefaultLayout from "@/layouts/default";

export default function EngineeringIndustrialPage() {
  ...
  const keyAdvantages = [
    {
      ...
      description:
        "Expert team optimizes the supply chain flow for economical and efficient logistics solutions.",
    },
    {
      icon: <FaShippingFast className="w-6 h-6 text-blue-600" />,
      title: "24/7 On-Time Delivery",
      description:
        "Round-the-clock logistics support to ensure timely deliveries for critical engineering and industrial products.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Serving engineering and industrial product industries with comprehensive logistics solutions worldwide.",
    },
  ];

  const faqData = [
    {
      question: "What services do you offer for the engineering and industrial products industry?",
      answer:
        "We provide custom logistics solutions, including optimized supply chain management, turn-key systems, and tech-driven logistics for engineering and industrial products.",
    },
    {
      question: "How do you optimize the supply chain for engineering products?",
      answer:
        "Our expert team leverages industry knowledge and advanced technology to streamline the supply chain, ensuring economical solutions without compromising service standards.",
    },
    {
      question: "Which areas in India do you serve for engineering logistics?",
      answer:
        "Based in Mumbai, we provide seamless logistics services across India, with strong connectivity to major industrial hubs.",
    },
    {
      question: "Do you support global engineering and industrial logistics?",
      answer:
        "Yes, we serve a global network, supporting engineering and industrial product industries with comprehensive logistics solutions worldwide.",
    },
    {
      question: "What technology do you use for engineering logistics?",
      answer:
        "We employ advanced tracking, real-time updates, automation, and data analytics to ensure precision and efficiency in engineering and industrial supply chains.",
    },
  ];
  ...
  const breadcrumbTrail = [
    ...
    { label: "Engineering & Industrial", icon: <FaGears /> },
  ];
            ...
            <div className="text-white">
              <div className="mb-6">
                <Chip className="mb-4" color="primary" variant="shadow">
                  Engineering & Industrial Logistics
                </Chip>
                <h1 className="text-4xl md:text-5xl font-bold mb-4">
                  Engineering & Industrial Solutions
                </h1>
                <h2 className="text-2xl md:text-3xl font-semibold mb-4 text-blue-200">
                  Precision Logistics for Manufacturing
                </h2>
                <p className="text-lg text-blue-100 mb-6">
                  Mansi Shipping Agency delivers tailored solutions for engineering
                  and industrial products, ensuring efficiency and optimization
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  <span className="text-blue-100">
                    Global Network for Industrial Logistics
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
              ...
              <div className="relative bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
                <div className="text-center mb-6">
                  <div className="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                    <FaGears className="w-10 h-10 text-white" />
                  </div>
                  <h3 className="text-white text-xl font-semibold mb-2">
                    Engineering & Industrial Solutions
                  </h3>
                  <p className="text-blue-100">Efficiency & Optimization</p>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Engineering & Industrial – Efficiency, Optimization, Global
            </h2>
            <div>
                    ...
                    <div className="flex-1">
                      <p className="text-xl text-gray-700 leading-relaxed">
                        ...
                        <span className="font-bold text-transparent bg-gradient-to-r from-blue-600 to-sky-400 bg-clip-text">
                          engineering and industrial logistics
                        </span>
                        , providing optimized solutions from sourcing to transporting finished goods.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <p className="text-xl text-gray-700 leading-relaxed">
                        ...
                        for engineering and industrial logistics.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Tailored Logistics for Engineering & Industrial
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our specialized services ensure efficiency, optimization, and
              reliability for engineering and industrial supply chains.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Precision Logistics for Engineering & Industrial
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our expertise and technology ensure reliable, optimized, and
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Know More About Engineering & Industrial Logistics
            </h2>
            <p className="text-lg text-gray-600">
              Get answers to common questions about our logistics solutions for
              the engineering and industrial products industry.
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-800 rounded-[10px]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Need Optimized Engineering Logistics?
          </h2>
          <p className="text-xl text-blue-100 mb-8">
            Let Mansi Shipping Agency manage your engineering and industrial
            supply chain with tailored, optimized, and tech-driven solutions.
          </p>
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-blue-100 text-sm">Economical Solutions</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
