...
export default function OilGasPage() {
  ...
  const keyAdvantages = [
    {
      ...
      description:
        "Robust system for upstream, downstream, and integrated oil and gas logistics needs.",
    },
    {
      icon: <FaShippingFast className="w-6 h-6 text-blue-600" />,
      title: "Global Supply Chain",
      description:
        "Specialized network with Middle East, South America, and African countries for seamless logistics.",
    },
    {
      icon: <Factory className="w-6 h-6 text-blue-600" />,
      title: "Mumbai-Based Hub",
      description:
        "Strong presence in Mumbai, ensuring efficient connectivity for oil and gas logistics.",
    },
    {
      icon: <Globe className="w-6 h-6 text-blue-600" />,
      title: "Sector Expertise",
      description:
        "Proven experience in chemical, engineering, procurement, and construction sectors.",
    },
  ];

  const faqData = [
    {
      question: "What services do you offer for the oil and gas industry?",
      answer:
        "We provide custom logistics solutions, including end-to-end supply chain management, specialized handling for upstream and downstream operations, and tech-driven logistics for the oil and gas industry.",
    },
    {
      question: "How do you manage global oil and gas logistics?",
      answer:
        "Our specialized supply chain network with Middle East, South America, and African countries ensures seamless and efficient logistics for the oil and gas industry.",
    },
    {
      question: "Which areas in India do you serve for oil and gas logistics?",
      answer:
        "Based in Mumbai, we provide seamless logistics services across India, with strong connectivity to major industrial hubs.",
    },
    {
      question:
        "Do you support logistics for chemical and procurement sectors?",
      answer:
        "Yes, we have extensive experience in handling chemical, engineering, procurement, and construction sectors within the oil and gas industry.",
    },
    {
      question: "What technology do you use for oil and gas logistics?",
      answer:
        "We employ advanced tracking, real-time updates, automation, and data analytics to ensure precision and efficiency in oil and gas supply chains.",
    },
  ];
  ...
  const breadcrumbTrail = [
    ...
    { label: "Oil & Gas", icon: <MdOilBarrel /> },
  ];
  ...
  return (
    <DefaultLayout breadcrumbs={breadcrumbTrail}>
      <section
        id="start"
        className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-blue-800 rounded-[10px] overflow-hidden"
      >
            ...
            <div className="text-white">
              <div className="mb-6">
                ...
                <h2 className="text-2xl md:text-3xl font-semibold mb-4 text-blue-200">
                  Robust Logistics for Energy Giants
                </h2>
                <p className="text-lg text-blue-100 mb-6">
                  Mansi Shipping Agency delivers tailored solutions for oil and
                  gas logistics, ensuring efficiency and reliability across
              ...
              <div className="relative bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
                <div className="text-center mb-6">
                  <div className="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                    <MdOilBarrel className="w-10 h-10 text-white" />
                  </div>
                  <h3 className="text-white text-xl font-semibold mb-2">
                    Oil & Gas Solutions
                  </h3>
                  <p className="text-blue-100">Efficiency & Reliability</p>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Oil & Gas – Efficiency, Reliability, Global
            </h2>
            <div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <p className="text-xl text-gray-700 leading-relaxed">
                        ...
                        , providing robust solutions for upstream, downstream,
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Tailored Logistics for Oil & Gas
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our specialized services ensure efficiency, reliability, and
              scalability for oil and gas supply chains.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Precision Logistics for Oil & Gas
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our expertise and technology ensure reliable, efficient, and
              scalable logistics for your critical operations.
            </p>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Know More About Oil & Gas Logistics
            </h2>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-800 rounded-[10px]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Need Robust Oil & Gas Logistics?
          </h2>
          <p className="text-xl text-blue-100 mb-8">
            Let Mansi Shipping Agency manage your oil and gas supply chain with
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-blue-100 text-sm">Upstream & Downstream</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
