...
export default function GreenEnergyPage() {
  ...
  const keyAdvantages = [
    {
      ...
      title: "Green Energy Expertise",
      description:
        "Specialized logistics for solar, wind turbine, and semiconductor industries.",
    },
    {
      icon: <FaShippingFast className="w-6 h-6 text-blue-600" />,
      title: "Global Market Reach",
      description:
        "Strong supply chain network with Sri Lanka, Ghana, Tanzania, Kenya, and South Africa.",
    },
    {
      icon: <Factory className="w-6 h-6 text-blue-600" />,
      title: "Mumbai-Based Hub",
      description:
        "Strategic presence in Mumbai for seamless green energy logistics.",
    },
    {
      icon: <Globe className="w-6 h-6 text-blue-600" />,
      title: "Comprehensive Services",
      descripción:
        "Equipment logistics, replacement parts, and after-sales services for rapid innovation cycles.",
    },
  ];

  const faqData = [
    {
      question: "What services do you offer for solar and wind mill logistics?",
      answer:
        "We provide tailored logistics solutions, including equipment transport, replacement parts logistics, after-sales services, and tech-driven supply chain management for solar, wind turbine, and semiconductor industries.",
    },
    {
      question: "Which global markets do you serve for green energy logistics?",
      answer:
        "We have a specialized supply chain network with Sri Lanka, Ghana, Tanzania, Kenya, and South Africa, ensuring seamless logistics for green energy industries.",
    },
    {
      question: "How do you support fast innovation cycles in green energy?",
      answer:
        "Our tailored logistics solutions, rapid onboarding, and advanced technology enable quick responses to innovation cycles in the solar and wind industries.",
    },
    {
      question: "Which areas in India do you serve for green energy logistics?",
      answer:
        "Based in Mumbai, we provide seamless logistics services across India, with strong connectivity to major green energy hubs.",
    },
    {
      question: "What technology do you use for solar and wind logistics?",
      answer:
        "We employ advanced tracking, real-time updates, automation, and data analytics to ensure precision and efficiency in green energy supply chains.",
    },
  ];
  ...
  const breadcrumbTrail = [
    ...
    { label: "Solar & Wind Mill", icon: <MdEnergySavingsLeaf /> },
  ];
            ...
            <div className="text-white">
              <div className="mb-6">
                <Chip className="mb-4" color="primary" variant="shadow">
                  Solar & Wind Mill Logistics
                </Chip>
                <h1 className="text-4xl md:text-5xl font-bold mb-4">
                  Solar & Wind Mill Solutions
                </h1>
                <h2 className="text-2xl md:text-3xl font-semibold mb-4 text-blue-200">
                  Empowering Green Energy Logistics
                </h2>
                <p className="text-lg text-blue-100 mb-6">
                  Mansi Shipping Agency delivers tailored logistics solutions
                  for solar and wind mill industries, ensuring efficiency and
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  <span className="text-blue-100">
                    Global Network for Green Energy
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
              ...
              <div className="relative bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
                <div className="text-center mb-6">
                  <div className="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                    <MdEnergySavingsLeaf className="w-10 h-10 text-white" />
                  </div>
                  <h3 className="text-white text-xl font-semibold mb-2">
                    Solar & Wind Mill Solutions
                  </h3>
                  <p className="text-blue-100">Efficiency & Innovation</p>
                </div>
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div className="bg-white/10 rounded-lg p-4">
                    <div className="text-2xl font-bold text-white">Global</div>
                    <div className="text-blue-100 text-sm">Network Reach</div>
                  </div>
                  <div className="bg-white/10 rounded-lg p-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Solar & Wind Mill – Efficiency, Innovation, Global
            </h2>
            <div>
                    ...
                    <div className="flex-1">
                      <p className="text-xl text-gray-700 leading-relaxed">
                        ...
                        <span className="font-bold text-transparent bg-gradient-to-r from-blue-600 to-sky-400 bg-clip-text">
                          solar and wind mill logistics
                        </span>
                        , supporting semiconductor, wind turbine, and solar
                        industries.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <p className="text-xl text-gray-700 leading-relaxed">
                        ...
                        ensures seamless connectivity for green energy
                        logistics.
                      </p>
                    </div>
                  </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Tailored Logistics for Solar & Wind Mill
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our specialized services ensure efficiency, innovation, and
              reliability for solar and wind mill supply chains.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Precision Logistics for Solar & Wind Mill
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our expertise and technology ensure reliable, innovative, and
              efficient logistics for your green energy operations.
            </p>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Know More About Solar & Wind Mill Logistics
            </h2>
            <p className="text-lg text-gray-600">
              Get answers to common questions about our logistics solutions for
              the solar and wind mill industries.
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-800 rounded-[10px]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Need Efficient Solar & Wind Logistics?
          </h2>
          <p className="text-xl text-blue-100 mb-8">
            Let Mansi Shipping Agency manage your solar and wind mill supply
            chain with tailored, innovative, and tech-driven solutions.
          </p>
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-blue-100 text-sm">Solar & Wind Solutions</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
