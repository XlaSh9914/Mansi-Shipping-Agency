...
export default function HealthcarePage() {
  ...
  const keyAdvantages = [
    {
      ...
      description:
        "Expert handling of drug control norms such as CDSCO, ADC, and FSSAI for pharmaceutical logistics.",
    },
    {
      icon: <FaShippingFast className="w-6 h-6 text-blue-600" />,
      title: "24/7 On-Time Delivery",
      description:
        "Round-the-clock logistics support to ensure timely deliveries for critical healthcare products.",
    },
    {
      icon: <Factory className="w-6 h-6 text-blue-600" />,
      title: "Strategic India Hubs",
      description:
        "Strong presence in Mumbai, Delhi, Gurgaon, Hyderabad, Bangalore, and Chennai for seamless connectivity.",
    },
    {
      icon: <Globe className="w-6 h-6 text-blue-600" />,
      title: "Global Network",
      description:
        "Serving pharmaceutical, biotech, and medical device industries across 194+ countries.",
    },
  ];

  const faqData = [
    {
      question: "What services do you offer for the pharmaceutical industry?",
      answer:
        "We provide custom logistics solutions, including specialized handling, regulatory compliance with CDSCO, ADC, and FSSAI, turn-key systems, and tech-driven supply chain management for pharmaceuticals, biotech, and medical devices.",
    },
    {
    ...
    {
      question: "Do you support global pharmaceutical logistics?",
      answer:
        "Yes, we serve a global network across 194+ countries, supporting pharmaceutical, biotech, and medical device industries with comprehensive logistics solutions.",
    },
    {
      question: "What technology do you use for pharmaceutical logistics?",
      answer:
        "We employ advanced tracking, real-time updates, automation, and data analytics to ensure precision and efficiency in pharmaceutical supply chains.",
    },
  ];
  ...
  const breadcrumbTrail = [
    ...
    { label: "Pharmaceuticals & Biotech", icon: <FaAmbulance /> },
  ];
              ...
              <div className="relative bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
                <div className="text-center mb-6">
                  <div className="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                    <FaAmbulance className="w-10 h-10 text-white" />
                  </div>
                    ...
                    <div className="flex-1">
                      <p className="text-xl text-gray-700 leading-relaxed">
                        ...
                        <span className="font-bold text-blue-600">
                          compliance with CDSCO, ADC, and FSSAI
                        </span>{" "}
                        ensures seamless operations for healthcare logistics.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Tailored Logistics for Pharmaceuticals & Biotech
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our specialized services ensure precision, compliance, and
              efficiency for pharmaceutical and biotech supply chains.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Precision Logistics for Pharmaceuticals & Biotech
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Know More About Pharmaceutical & Biotech Logistics
            </h2>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-blue-100 text-sm">CDSCO, ADC, FSSAI Met</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
